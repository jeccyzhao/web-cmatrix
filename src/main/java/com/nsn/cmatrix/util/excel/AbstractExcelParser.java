...
public abstract class AbstractExcelParser 
{
	 ...
	 * @throws Exception
	 */
	public abstract void open (String xlsFile) throws Exception;

	public abstract void openSheet (int sheetIndex) throws Exception;

	public abstract void close();
	
	public abstract Integer getNumberOfSheets () throws Exception;
	...
	public abstract Object getCellContent(Object paramObject, boolean is2007);
